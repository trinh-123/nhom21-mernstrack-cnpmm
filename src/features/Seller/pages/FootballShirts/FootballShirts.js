...
import ShirtsToolbar from "../../../Seller/pages/FootballShirts/components/ShirtsToolbar/ShirtsToolbar";
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        const response = await shirtsApi.getBySeller(params.sellerId);
